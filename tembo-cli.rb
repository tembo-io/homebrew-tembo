class TemboCli < Formula
  ...
  if OS.mac?
    ...
    if uname.strip == "arm64"
      ...
      sha256 "a47ed147e2fdd4ed38aafb018b07ac60c64165b5e9c0dd363b98dd8def8de0f5"
    else
      @@filename = "tembo-cli-#{version}-x86_64-apple.tar.gz"
      url "https://github.com/tembo-io/tembo/releases/download/#{@@release_version}/#{@@filename}"
      sha256 "5e1335b355eea6baf9e8fa35547894d16f3737102927d418ff1594eefcb91129"
    end
  elsif OS.linux?
