class TemboCli < Formula
  ...
  if OS.mac?
    ...
    if uname.strip == "arm64"
      ...
      sha256 "e2095cf677b0d12ac44eacf9ac26791a106f486bf9e5ac1a2437ae1b5f624371"
    else
      @@filename = "tembo-cli-#{version}-x86_64-apple.tar.gz"
      url "https://github.com/tembo-io/tembo/releases/download/#{@@release_version}/#{@@filename}"
      sha256 "0ed370a3c88197017f957638ff7628f0d1e965bdcdc39111cd21b4757ce00438"
    end
  elsif OS.linux?
